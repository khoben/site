...
app.post('/edit/car/:id', upload.single('img_path'), (req, res) => {
    ...
    if (req.file) {
        ...
        console.log("UPDATE car set img_path = {0} WHERE ID = {1}".format(mysql_real_escape_string(newImgPath), req.params.id));

        car = new Car();
        car.query("UPDATE car set img_path = '{0}' WHERE ID = {1}".format(mysql_real_escape_string(newImgPath), req.params.id), (err, car) => {
